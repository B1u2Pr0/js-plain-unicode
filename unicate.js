...
function update() {
  ...
  var t = translate($('#in-text').val().substr(intext.selectionStart, intext.selectionEnd - intext.selectionStart));
  var res = $('#out-text').val().substr(0, intext.selectionStart * 2);
  res += t;
  res +=$('#out-text').val().substr(intext.selectionEnd * 2, $('#in-text').val().length * 2 - intext.selectionEnd * 2)
  $('#out-text').val(res);
}
...
function onSelect() {
  ...
  outtext.selectionStart = intext.selectionStart * 2;
  outtext.selectionEnd = intext.selectionEnd * 2;
//  outtext.setSelectionRange(intext.selectionStart * 2, intext.selectionEnd * 2)
}
